  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass max-w-md p-8 text-center">
        <h1 className="font-display text-7xl neon-text">404</h1>
        <h2 className="mt-4 text-xl font-semibold">Signal lost</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          That route doesn't exist on this network.
        </p>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass max-w-md p-8 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The page failed to load. You can try again or head home.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered cybersecurity intelligence platform that predicts zero-day vulnerabilities in URLs, code, and logs." },
      { name: "author", content: "AI-ZeroDay-Predictor" },
      { property: "og:title", content: "AI-ZeroDay-Predictor — Predict. Prevent. Protect." },
      { property: "og:description", content: "AI-powered cybersecurity intelligence platform that predicts zero-day vulnerabilities in URLs, code, and logs." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "AI-ZeroDay-Predictor — Predict. Prevent. Protect." },
      { name: "twitter:description", content: "AI-powered cybersecurity intelligence platform that predicts zero-day vulnerabilities in URLs, code, and logs." },
