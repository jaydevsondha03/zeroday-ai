...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Predict zero-day vulnerabilities in URLs, code snippets, and system logs with AI-driven heuristic security modeling." },
      { property: "og:title", content: "AI-ZeroDay-Predictor" },
      { property: "og:description", content: "AI-powered cybersecurity intelligence — predict, prevent, protect." },
    ],
  }),
  component: Landing,
});
